...
func (Operator_OpKind) EnumDescriptor() ([]byte, []int) {
	return file_proto_expression_proto_rawDescGZIP(), []int{6, 0}
}
...
var file_proto_expression_proto_rawDesc = []byte{
	...
	0x6f, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x04, 0x50, 0x61, 0x73, 0x63, 0x22, 0xd1,
	...
	0x52, 0x04, 0x61, 0x72, 0x67, 0x73, 0x22, 0xb5, 0x01, 0x0a, 0x08, 0x4f, 0x70, 0x65, 0x72, 0x61,
	...
	0x4f, 0x70, 0x4b, 0x69, 0x6e, 0x64, 0x52, 0x02, 0x6f, 0x70, 0x22, 0x81, 0x01, 0x0a, 0x06, 0x4f,
	...
	0x73, 0x10, 0x09, 0x12, 0x09, 0x0a, 0x05, 0x47, 0x72, 0x65, 0x61, 0x74, 0x10, 0x0a, 0x12, 0x0e,
	0x0a, 0x0a, 0x47, 0x72, 0x65, 0x61, 0x74, 0x45, 0x71, 0x75, 0x61, 0x6c, 0x10, 0x0b, 0x42, 0x18,
	0x5a, 0x16, 0x70, 0x6b, 0x67, 0x2f, 0x63, 0x6f, 0x64, 0x65, 0x67, 0x65, 0x6e, 0x2f, 0x73, 0x65,
	0x72, 0x69, 0x61, 0x6c, 0x69, 0x7a, 0x65, 0x72, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
var file_proto_expression_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
var file_proto_expression_proto_goTypes = []interface{}{
	...
	(*FuncCall)(nil),                   // 8: Pasc.FuncCall
	(*Operator)(nil),                   // 9: Pasc.Operator
	(*Identifier_Variable)(nil),        // 10: Pasc.Identifier.Variable
	(*Identifier_IndexedVariable)(nil), // 11: Pasc.Identifier.IndexedVariable
	(*Identifier_FieldDesignator)(nil), // 12: Pasc.Identifier.FieldDesignator
}
var file_proto_expression_proto_depIdxs = []int32{
	0,  // 0: Pasc.Identifier.kind:type_name -> Pasc.Identifier.IDKind
	10, // 1: Pasc.Identifier.var:type_name -> Pasc.Identifier.Variable
	11, // 2: Pasc.Identifier.iv:type_name -> Pasc.Identifier.IndexedVariable
	12, // 3: Pasc.Identifier.fld:type_name -> Pasc.Identifier.FieldDesignator
	...
	8,  // 9: Pasc.Expression.fc:type_name -> Pasc.FuncCall
	4,  // 10: Pasc.WriteParameter.e:type_name -> Pasc.Expression
	4,  // 11: Pasc.WriteParameter.totalWidth:type_name -> Pasc.Expression
	4,  // 12: Pasc.WriteParameter.fracDigits:type_name -> Pasc.Expression
	4,  // 13: Pasc.BinaryExpr.left:type_name -> Pasc.Expression
	4,  // 14: Pasc.BinaryExpr.right:type_name -> Pasc.Expression
	9,  // 15: Pasc.BinaryExpr.op:type_name -> Pasc.Operator
	4,  // 16: Pasc.FuncCall.name:type_name -> Pasc.Expression
	4,  // 17: Pasc.FuncCall.args:type_name -> Pasc.Expression
	2,  // 18: Pasc.Operator.op:type_name -> Pasc.Operator.OpKind
