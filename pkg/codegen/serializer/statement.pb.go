...
var file_proto_statement_proto_rawDesc = []byte{
	...
	0x72, 0x22, 0xcb, 0x04, 0x0a, 0x09, 0x53, 0x74, 0x61, 0x74, 0x65, 0x6d, 0x65, 0x6e, 0x74, 0x12,
	...
	,
}
...
var file_proto_statement_proto_msgTypes = make([]protoimpl.MessageInfo, 14)
var file_proto_statement_proto_goTypes = []interface{}{
	...
	(*Statement)(nil),                   // 10: Pasc.Statement
	(*ProcedureStatement_WriteLn)(nil),  // 11: Pasc.ProcedureStatement.WriteLn
	(*ProcedureStatement_Write)(nil),    // 12: Pasc.ProcedureStatement.Write
	(*ProcedureStatement_Read)(nil),     // 13: Pasc.ProcedureStatement.Read
	(*ProcedureStatement_ReadLn)(nil),   // 14: Pasc.ProcedureStatement.ReadLn
	(*ProcedureStatement_ProcStmt)(nil), // 15: Pasc.ProcedureStatement.ProcStmt
	(*Expression)(nil),                  // 16: Pasc.Expression
	(TokenKind)(0),                      // 17: Pasc.TokenKind
}
var file_proto_statement_proto_depIdxs = []int32{
	0,  // 0: Pasc.ProcedureStatement.kind:type_name -> Pasc.ProcedureStatement.PSKind
	12, // 1: Pasc.ProcedureStatement.wrt:type_name -> Pasc.ProcedureStatement.Write
	11, // 2: Pasc.ProcedureStatement.wrtLn:type_name -> Pasc.ProcedureStatement.WriteLn
	13, // 3: Pasc.ProcedureStatement.rd:type_name -> Pasc.ProcedureStatement.Read
	14, // 4: Pasc.ProcedureStatement.rdLn:type_name -> Pasc.ProcedureStatement.ReadLn
	15, // 5: Pasc.ProcedureStatement.ps:type_name -> Pasc.ProcedureStatement.ProcStmt
	16, // 6: Pasc.AssignStatement.variable:type_name -> Pasc.Expression
	16, // 7: Pasc.AssignStatement.value:type_name -> Pasc.Expression
	16, // 8: Pasc.IfStatement.cond:type_name -> Pasc.Expression
	10, // 9: Pasc.IfStatement.truePath:type_name -> Pasc.Statement
	10, // 10: Pasc.IfStatement.elsePath:type_name -> Pasc.Statement
	16, // 11: Pasc.ReturnStatement.value:type_name -> Pasc.Expression
	16, // 12: Pasc.WhileStatement.cond:type_name -> Pasc.Expression
	10, // 13: Pasc.WhileStatement.body:type_name -> Pasc.Statement
	10, // 14: Pasc.CompoundStatement.stmts:type_name -> Pasc.Statement
	10, // 15: Pasc.RepeatStatement.stmts:type_name -> Pasc.Statement
	16, // 16: Pasc.RepeatStatement.cond:type_name -> Pasc.Expression
	16, // 17: Pasc.ForStatement.ctlVar:type_name -> Pasc.Expression
	16, // 18: Pasc.ForStatement.initValue:type_name -> Pasc.Expression
	16, // 19: Pasc.ForStatement.finalValue:type_name -> Pasc.Expression
	10, // 20: Pasc.ForStatement.body:type_name -> Pasc.Statement
	17, // 21: Pasc.ForStatement.dir:type_name -> Pasc.TokenKind
	1,  // 22: Pasc.Statement.kind:type_name -> Pasc.Statement.StmtKind
	3,  // 23: Pasc.Statement.assignStmt:type_name -> Pasc.AssignStatement
	2,  // 24: Pasc.Statement.procStmt:type_name -> Pasc.ProcedureStatement
	4,  // 25: Pasc.Statement.ifStmt:type_name -> Pasc.IfStatement
	5,  // 26: Pasc.Statement.retStmt:type_name -> Pasc.ReturnStatement
	6,  // 27: Pasc.Statement.whileStmt:type_name -> Pasc.WhileStatement
	7,  // 28: Pasc.Statement.cmpdStmt:type_name -> Pasc.CompoundStatement
	8,  // 29: Pasc.Statement.rptStmt:type_name -> Pasc.RepeatStatement
	9,  // 30: Pasc.Statement.forStmt:type_name -> Pasc.ForStatement
	16, // 31: Pasc.ProcedureStatement.WriteLn.file:type_name -> Pasc.Expression
	16, // 32: Pasc.ProcedureStatement.WriteLn.params:type_name -> Pasc.Expression
	16, // 33: Pasc.ProcedureStatement.ProcStmt.name:type_name -> Pasc.Expression
	16, // 34: Pasc.ProcedureStatement.ProcStmt.params:type_name -> Pasc.Expression
...
func file_proto_statement_proto_init() {
	...
	file_proto_statement_proto_msgTypes[8].OneofWrappers = []interface{}{
